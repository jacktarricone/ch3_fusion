...
nc_data <- s3read_using(FUN = nc_open, object = "20040111090000-JPL-L4_GHRSST-SSTfnd-MUR25-GLOB-v02.0-fv04.2.nc", 
                        bucket="podaac-ops-cumulus-protected/MUR25-JPL-L4-GLOB-v04.2",
                        verbose = TRUE)
