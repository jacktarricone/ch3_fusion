...
######### UPDATE this!!!!!!!!!!#######
# select row 4 for p4, no PD pit for these days
p4_v1 <-pit_diff[4,]
p4 <-subset(p4_v1, select = -X)
p4

# rbind
station_dswe <-rbind(station_dswe_v1,p4)
station_dswe
...
for (i in 1:length(names)) {
  ...
  dataset <-names[i]
  writeRaster(dswe[[i]], paste0("~/ch3_fusion/rasters/new_dswe/p4/p4_",dataset,"_dswe_cm_v6.tif"))
